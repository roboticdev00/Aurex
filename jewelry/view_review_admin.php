...
<head>
    ...
    <title>Product Reviews - <?php echo htmlspecialchars($product['ProductName'] ?? 'Product'); ?> - Jewellery</title>
...
<body class="flex antialiased">
    <div class="w-64 admin-sidebar h-screen p-6 fixed flex flex-col shadow-2xl">
        ...
        <ul class="space-y-2 flex-grow">
            <li><a href="admin_dashboard.php" class="block p-3 rounded text-white hover:bg-brand-teal hover:shadow-md transition-all">
                <span class="font-medium">Dashboard</span>
            </a></li>
            <li><a href="manage_users.php" class="block p-3 rounded text-white hover:bg-brand-teal hover:shadow-md transition-all">
                <span class="font-medium">Manage Users</span>
            </a></li>
            <li><a href="manage_products.php" class="block p-3 rounded text-white hover:bg-brand-teal hover:shadow-md transition-all">
                <span class="font-medium">Manage Products</span>
            </a></li>
            <li><a href="manage_orders.php" class="block p-3 rounded text-white hover:bg-brand-teal hover:shadow-md transition-all">
    ...
    <div class="flex-1 ml-64 p-10">
        <div class="flex justify-between items-center mb-10">
            <h2 class="font-serif text-4xl font-bold text-brand-dark">Product Reviews</h2>
            <a href="manage_ratings.php" class="bg-white text-brand-teal px-6 py-2 rounded-full text-sm font-semibold hover:bg-gray-100 transition-colors shadow-md">
                Back to Home
            </a>
        </div>
                ...
                <div class="lg:col-span-2">
                    ...
                    <?php if (empty($reviews)): ?>
                        <div class="no-reviews">
                            ...
                            <p class="text-brand-subtext">This product has no reviews yet</p>
                        </div>
                    <?php else: ?>
                                        ...
                                        <div class="flex-grow">
                                            <div class="flex justify-between items-start mb-2">
                                                <div>
                                                    ...
                                                    <p class="text-sm text-brand-subtext"><?php echo htmlspecialchars($review['Email']); ?></p>
                                                    <div class="star-rating">
                                                        <?php 
                                                        for ($i = 1; $i <= 5; $i++) {
                                                            if ($i <= $review['Rating']) {
