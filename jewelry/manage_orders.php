...
// Calculate Total Orders for "All" card
...
<head>
    <meta charset="UTF-8">
    <title>Manage Orders - Aurex Jewelry</title>
    ...
    /* Updated Logout Button to match other pages */
    .logout-btn {
...
<body class="flex antialiased">
    ...
    <div class="w-64 admin-sidebar h-screen p-6 fixed flex flex-col shadow-2xl">
        ...
        <ul class="space-y-2 flex-grow">
            ...
            <li><a href="manage_orders.php" class="block p-3 rounded text-white nav-active transition-all">Manage Orders</a></li>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4 mb-8">
            ...
            <a href="manage_orders.php" 
               ...
               class="stats-card p-6 cursor-pointer relative overflow-hidden group <?= $filterStatus === null ? 'active' : '' ?>">
                <div class="flex items-start justify-between">
                    <div class="flex-1">
                        <h3 class="stats-label font-semibold uppercase mb-2 group-hover:text-brand-teal transition-colors">All Orders</h3>
            ...
            <a href="?status=Pending" 
               ...
               class="stats-card p-6 cursor-pointer relative overflow-hidden group <?= $filterStatus === 'Pending' ? 'active' : '' ?>">
                <div class="flex items-start justify-between">
                    <div class="flex-1">
                        <h3 class="stats-label font-semibold uppercase mb-2 group-hover:text-brand-teal transition-colors">Pending</h3>
            ...
            <a href="?status=Processing" 
               ...
               class="stats-card p-6 cursor-pointer relative overflow-hidden group <?= $filterStatus === 'Processing' ? 'active' : '' ?>">
                <div class="flex items-start justify-between">
                    <div class="flex-1">
                        <h3 class="stats-label font-semibold uppercase mb-2 group-hover:text-brand-teal transition-colors">Processing</h3>
            ...
            <a href="?status=Shipped" 
               ...
               class="stats-card p-6 cursor-pointer relative overflow-hidden group <?= $filterStatus === 'Shipped' ? 'active' : '' ?>">
                <div class="flex items-start justify-between">
                    <div class="flex-1">
                        <h3 class="stats-label font-semibold uppercase mb-2 group-hover:text-brand-teal transition-colors">Shipped</h3>
            ...
            <a href="?status=Delivered" 
               ...
               class="stats-card p-6 cursor-pointer relative overflow-hidden group <?= $filterStatus === 'Delivered' ? 'active' : '' ?>">
                <div class="flex items-start justify-between">
                    <div class="flex-1">
                        <h3 class="stats-label font-semibold uppercase mb-2 group-hover:text-brand-teal transition-colors">Delivered</h3>
            ...
            <a href="?status=Cancelled" 
               ...
               class="stats-card p-6 cursor-pointer relative overflow-hidden group <?= $filterStatus === 'Cancelled' ? 'active' : '' ?>">
                <div class="flex items-start justify-between">
                    <div class="flex-1">
                        <h3 class="stats-label font-semibold uppercase mb-2 group-hover:text-brand-teal transition-colors">Cancelled</h3>
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200">
            <div class="p-6 border-b border-gray-200 flex justify-between items-center">
                <div>
                    ...
                    <?php if ($filterStatus): ?>
                    <span class="text-sm text-gray-500">Filter applied. <a href="manage_orders.php" class="text-brand-teal hover:underline">Show all orders</a></span>
                    <?php endif; ?>
                </div>
                <?php if ($filterStatus): ?>
                <a href="manage_orders.php" class="px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg text-sm font-medium transition-colors">
                    Clear Filter
                </a>
                <?php endif; ?>
            </div>
            ...
            <div class="p-8 text-center">
                <?php if ($filterStatus): ?>
                    <p class="text-gray-500 text-lg">No orders found with status "<?= htmlspecialchars($filterStatus) ?>".</p>
                    <a href="manage_orders.php" class="text-brand-teal hover:underline mt-2 inline-block">View all orders</a>
                <?php else: ?>
                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 space-x-2">
                                <button
                                    class="view-order-btn px-3 py-1 bg-brand-teal text-white rounded text-xs font-semibold hover:bg-opacity-90 transition-colors"
    ...
    <div id="order-details-modal"
        ...
        <div class="modal-panel relative w-full max-w-2xl bg-white rounded-lg shadow-xl p-8">
            ...
            <button id="close-modal-bottom"
                class="w-full mt-6 bg-brand-teal text-white py-2.5 rounded-full font-semibold hover:bg-opacity-90 transition-colors">Close</button>
        </div>
    </div>
            ...
            <form id="status-form">
                ...
                <div class="mb-6">
                    ...
                    <select id="new-status"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-teal">
                ...
                <div class="flex gap-3">
                    <button type="submit"
                        class="flex-1 bg-brand-teal text-white py-2 rounded-lg font-semibold hover:bg-opacity-90 transition-colors">Update</button>
