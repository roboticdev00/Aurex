...
<head>
    <meta charset="UTF-8">
    <title>Admin Dashboard - Aurex Jewelry</title>
    ...
    <style>
        ...
        /* Card Design consistent with report styles */
        .stat-card {
            background-color: white;
            border-radius: 0.75rem;
            box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);
            transition: transform 0.2s ease, box-shadow 0.2s ease;
            border-top: 4px solid #8B7B61; /* Consistent Teal/Brown Border */
        }
...
<body class="flex antialiased">
    ...
    <div class="w-64 admin-sidebar h-screen p-6 fixed flex flex-col shadow-2xl z-20">
        ...
        <ul class="space-y-2 flex-grow">
            <li><a href="admin_dashboard.php" class="block p-3 rounded text-white nav-active transition-all">Dashboard</a></li>
    ...
    <div class="flex-1 ml-64 p-10">
        <div class="flex justify-between items-center mb-8">
            <h2 class="font-serif text-4xl font-bold text-brand-dark">Welcome, <?= $userName ?>!</h2>
        </div>
            ...
            <div class="stat-card p-6 relative overflow-hidden group">
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <p class="font-serif text-3xl font-extrabold text-brand-teal mt-1"><?= number_format($totalUsers) ?></p>
                    </div>
                    <div class="p-3 bg-brand-beige rounded-lg text-brand-teal group-hover:bg-brand-teal group-hover:text-white transition-colors">
                        <!-- User Profile Icon -->
            ...
            <div class="stat-card p-6 relative overflow-hidden group">
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <p class="font-serif text-3xl font-extrabold text-brand-teal mt-1"><?= number_format($totalProducts) ?></p>
                    </div>
                    <div class="p-3 bg-brand-beige rounded-lg text-brand-teal group-hover:bg-brand-teal group-hover:text-white transition-colors">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="stat-card p-6 relative overflow-hidden group">
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <p class="font-serif text-3xl font-extrabold text-brand-teal mt-1"><?= number_format($totalOrders) ?></p>
                    </div>
                    <div class="p-3 bg-brand-beige rounded-lg text-brand-teal group-hover:bg-brand-teal group-hover:text-white transition-colors">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="stat-card p-6 relative overflow-hidden group">
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <p class="font-serif text-2xl font-extrabold text-brand-teal mt-2 leading-none">₱<?= number_format($totalRevenue, 2) ?></p>
                    </div>
                    <div class="p-3 bg-brand-beige rounded-lg text-brand-teal group-hover:bg-brand-teal group-hover:text-white transition-colors">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="bg-white p-6 rounded-xl shadow-lg border border-gray-200 mb-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-5 gap-4">
                <div class="text-center p-4 bg-orange-50 rounded-lg border border-orange-100 hover:shadow-md transition-shadow">
                    <p class="text-2xl font-bold text-orange-600"><?= $pendingOrders ?></p>
                    <p class="text-sm text-orange-800 font-medium">Pending</p>
                </div>
                <div class="text-center p-4 bg-blue-50 rounded-lg border border-blue-100 hover:shadow-md transition-shadow">
                    <p class="text-2xl font-bold text-blue-600"><?= $processingOrders ?></p>
                    <p class="text-sm text-blue-800 font-medium">Processing</p>
                </div>
                <div class="text-center p-4 bg-purple-50 rounded-lg border border-purple-100 hover:shadow-md transition-shadow">
                    <p class="text-2xl font-bold text-purple-600"><?= $shippedOrders ?></p>
                    <p class="text-sm text-purple-800 font-medium">Shipped</p>
                </div>
                <div class="text-center p-4 bg-green-50 rounded-lg border border-green-100 hover:shadow-md transition-shadow">
                    <p class="text-2xl font-bold text-green-600"><?= $deliveredOrders ?></p>
                    <p class="text-sm text-green-800 font-medium">Delivered</p>
                </div>
                <div class="text-center p-4 bg-red-50 rounded-lg border border-red-100 hover:shadow-md transition-shadow">
            ...
            <div class="bg-white p-6 rounded-xl shadow-lg border border-gray-200">
                ...
                <div class="space-y-3">
                    ...
                    <?php else: ?>
                        ...
                        <div class="flex justify-between items-center p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors border border-gray-100">
                            <div>
                                <p class="font-bold text-brand-dark text-sm">#<?= $order['Order_ID'] ?> - <?= htmlspecialchars($order['Customer_Name']) ?></p>
                                <p class="text-xs text-brand-subtext mt-1"><?= date('M d, Y h:i A', strtotime($order['Order_Date'])) ?></p>
                            </div>
                            <div class="text-right flex flex-col items-end">
                                <p class="font-bold text-brand-teal text-sm">₱<?= number_format($order['Total_Amount'], 2) ?></p>
            ...
            <div class="bg-white p-6 rounded-xl shadow-lg border border-gray-200">
                ...
                <div class="space-y-3">
                    ...
                    <?php else: ?>
                        ...
                        ?>
                        <div class="flex justify-between items-center p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors border border-gray-100">
                            <div class="flex items-center min-w-0">
                                <span class="flex-shrink-0 w-6 h-6 bg-brand-teal text-white text-[10px] font-bold rounded-full flex items-center justify-center mr-3">
                                    <?= $index + 1 ?>
                                </span>
                                <img src="<?= $product_image ?>" alt="<?= htmlspecialchars($product['Name']) ?>" class="flex-shrink-0 w-10 h-10 rounded object-cover mr-3 border border-gray-200 shadow-sm">
                                <div class="min-w-0">
                                    <p class="font-semibold text-brand-dark text-sm truncate"><?= htmlspecialchars($product['Name']) ?></p>
                                    <p class="text-xs text-brand-subtext">Sold: <span class="font-medium text-brand-dark"><?= $product['Total_Sold'] ?></span></p>
                                </div>
                            </div>
                            <div class="flex-shrink-0 text-right pl-2">
                                <p class="font-bold text-brand-teal text-sm">₱<?= number_format($product['Revenue'], 2) ?></p>
                            </div>
                        </div>
                        <?php endforeach; ?>
                    <?php endif; ?>
        ...
        <h3 class="font-serif text-2xl font-bold text-brand-dark mb-5 border-b border-gray-200 pb-3">Management Modules</h3>
        
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <a href="manage_users.php" class="bg-white p-6 rounded-xl shadow-md hover:shadow-xl hover:bg-brand-beige text-center border border-gray-200 transition-all group">
                <div class="mb-4">
                    <svg class="w-12 h-12 mx-auto text-brand-teal group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="manage_products.php" class="bg-white p-6 rounded-xl shadow-md hover:shadow-xl hover:bg-brand-beige text-center border border-gray-200 transition-all group">
                <div class="mb-4">
                    <svg class="w-12 h-12 mx-auto text-brand-teal group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path>
                    </svg>
            ...
            <a href="manage_orders.php" class="bg-white p-6 rounded-xl shadow-md hover:shadow-xl hover:bg-brand-beige text-center border border-gray-200 transition-all group">
                <div class="mb-4">
                    <svg class="w-12 h-12 mx-auto text-brand-teal group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"></path>
                    </svg>
            ...
            <a href="manage_ratings.php" class="bg-white p-6 rounded-xl shadow-md hover:shadow-xl hover:bg-brand-beige text-center border border-gray-200 transition-all group">
                <div class="mb-4">
                    <svg class="w-12 h-12 mx-auto text-brand-teal group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
